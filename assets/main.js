...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-1', { style: 'fade-up', speed: 250, intensity: 0, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('.image-component.style-3', { style: 'zoom-out-image', speed: 250, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.style-2', { style: 'zoom-out-image', speed: 250, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'zoom-in', speed: 375, intensity: 1, threshold: 1, delay: 0, stagger: 0, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.image-component.style-1', { style: 'zoom-out-image', speed: 250, intensity: 4, threshold: 3, delay: 0, replay: false });
